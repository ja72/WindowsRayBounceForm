...
namespace JA.Gdi
{
    ...
    public struct ColorRgb : IEquatable<Color>
    {
        ...
        {
            this.A = alpha.ClampValue();
            this.R = red.ClampValue();
            this.G = green.ClampValue();
            this.B = blue.ClampValue();
        }
        ...
        /// <summary>Returns a <see cref="T:JA.Gdi.ColorHsl" /> reprezentation of current instance.</summary>
        /// <returns>A <see cref="T:JA.Gdi.ColorHsl" /> reprezentation of current instance</returns>
